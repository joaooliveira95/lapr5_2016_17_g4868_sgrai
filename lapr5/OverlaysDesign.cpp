...
void OverlaysDesign::desenhaKm(float x) {
	...
	//glScalef(2,2,0);
	sprintf_s(str, 255, "km");
	bitmapCenterString(str, width*0.9, height*0.9);

	sprintf_s(str, 255, "%.f", x);
	bitmapCenterString(str, width*0.75, height*0.9);
...
void OverlaysDesign::desenhaTempo(int x) {
	char str[255];
	...
	bitmapCenterString(str, width*0.2, height*0.9);
